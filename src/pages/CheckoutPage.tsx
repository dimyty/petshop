              ...
              <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
                ...
                <div className="border-t pt-4 space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{totals.subtotal.toFixed(2)} лв</span>
                  </div>
                  {totals.cashFee > 0 && (
                    <div className="flex justify-between">
                      <span className="text-gray-600">Такса наложен платеж:</span>
                      <span className="font-medium">{totals.cashFee.toFixed(2)} лв</span>
                    </div>
                  )}
                  {totals.discount > 0 && (
                    <div className="flex justify-between text-green-600">
                      <span>Отстъпка ({discountAmount}%):</span>
                      <span className="font-medium">-{totals.discount.toFixed(2)} лв</span>
                    </div>
                  )}
