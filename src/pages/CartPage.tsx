            ...
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{state.total.toFixed(2)} {currencySymbol}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Доставка:</span>
                  <span className="font-medium">
                    {state.total >= 50 ? 'Безплатна' : `5.99 ${currencySymbol}`}
                  </span>
                </div>
                <div className="border-t pt-4">
                  <div className="flex justify-between text-lg font-bold">
                    <span>Общо:</span>
                    <span>{(state.total + (state.total >= 50 ? 0 : 5.99)).toFixed(2)} {currencySymbol}</span>
                  </div>
                </div>
              </div>
              ...
              {state.total < 50 && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  <p className="text-sm text-blue-800">
                    Добавете още {(50 - state.total).toFixed(2)} {currencySymbol} за безплатна доставка!
                  </p>
                </div>
              )}
